...
class PlayerCtrl:
    ...
    def set_new_video(self, video_path):
        ...
        self._player.video_set_marquee_int(0, 1)  # Enable

        self._player.video_set_marquee_int(2, 0xFFFFFF)  # Цвет текста (белый)
        self._player.video_set_marquee_int(3, 60)  # Непрозрачность текста (0-255)
        self._player.video_set_marquee_int(4, 9)  # position
        self._player.video_set_marquee_int(6, 24)  # size in pixels

        self._player.video_set_marquee_int(7, 0)  # timeout
    ...
    def update(self):
        ...
        self._player.video_set_marquee_string(1, current_time)
    ...
    def event_handler(self):
        ...
        if keyboard.is_pressed('esc'):
            ...
            self._player.set_time(max(0, self._player.get_time()-1000))
            time.sleep(0.1)
